        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="rounded-2xl bg-slate-50 p-8">
            ...
            <div className="flex flex-wrap gap-2">
              {iptvChannels.map((ch) => (
                <span key={ch} className="px-3 py-1.5 rounded-full bg-white border border-slate-200 text-sm text-slate-700 hover:bg-yellow-500 hover:text-white hover:border-yellow-400 transition-colors cursor-default">
                  {ch}
                </span>
              ))}
            </div>
