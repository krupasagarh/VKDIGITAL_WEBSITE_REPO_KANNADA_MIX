      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-red-600 font-bold tracking-[0.25em] text-sm uppercase">Business Internet</p>
            ...
            {businessPlans.map((p) => (
              <div key={p.id} className="plan-card bg-white rounded-2xl p-7 border border-slate-100 shadow-sm">
                ...
                <div className="mt-3 flex items-end gap-1">
                  <span className="text-3xl font-extrabold text-red-600">₹{p.price}</span>
                ...
                <ul className="mt-5 space-y-2 text-sm text-slate-600">
                  ...
                  <li className="flex items-center gap-2"><Check size={16} className="text-red-600" /> Free Static IP</li>
                  <li className="flex items-center gap-2"><Check size={16} className="text-red-600" /> B2B GST Billing</li>
                  <li className="flex items-center gap-2"><Check size={16} className="text-red-600" /> Auto Renewal</li>
                  <li className="flex items-center gap-2"><Check size={16} className="text-red-600" /> Priority Support</li>
                </ul>
